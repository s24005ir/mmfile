...
Func void main()
{
    ...
    Matrix x0,T,X,U;
    Matrix diff_eqs(),link_eqs1(),link_eqs2(),link_eqs3(),link_eqs4();
    ...
    {T,X,U}=Ode45Auto(t0,t1,x0,diff_eqs,link_eqs1,tol);
    ...
    {T,X,U}=Ode45Auto(t0,t1,x0,diff_eqs,link_eqs2,tol);
    ...
    {T,X,U}=Ode45Auto(t0,t1,x0,diff_eqs,link_eqs3,tol);
    ...
    {T,X,U}=Ode45Auto(t0,t1,x0,diff_eqs,link_eqs4,tol);
